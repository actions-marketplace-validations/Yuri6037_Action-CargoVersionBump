...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (!(yield (0, utils_1.exists)(cargo))) {
                core.setFailed('No Cargo.toml found in the specified project directory');
            }
            const res = yield (0, tool_1.bumpVersion)(cargo, channel, { major, minor, patch });
...
const utils_1 = __nccwpck_require__(7696);
function bumpVersion(path, channel, bumps) {
    return __awaiter(this, void 0, void 0, function* () {
        const project = yield (0, utils_1.loadCargo)(path);
        const version = (0, utils_1.parseVersion)(project.version);
        ...
        (0, utils_1.saveCargo)(path, project);
        return {
...
class Version {
    ...
    format() {
        var _a, _b, _c;
        if (this.channel) {
            return `${this.core.major}.${this.core.minor}.${this.core.patch}-${this.channel}.${(_a = this.preRelease) === null || _a === void 0 ? void 0 : _a.major}.${(_b = this.preRelease) === null || _b === void 0 ? void 0 : _b.minor}.${(_c = this.preRelease) === null || _c === void 0 ? void 0 : _c.patch}`;
        }
        else {
