...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const project = (0, utils_1.loadCargo)(cargo);
            if (major) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.parseVersion = exports.Version = exports.loadCargo = exports.exists = void 0;
...
function loadCargo(path) {
    return __awaiter(this, void 0, void 0, function* () {
        const text = yield fs.promises.readFile(path, 'utf8');
